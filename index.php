        ...
        <aside class="hs-menu" id="hs-menu">
            ...
            <div class="hs-headline">
                ...
                <div class="profile_info">
                    <h1>Iram Gutiérrez</h1>
                    <h4>DESARROLLADOR WEB</h4>
                    <h6><span class="fa fa-location-arrow"></span>&nbsp;&nbsp;&nbsp;Distrito Federal , México</h6>
                </div>
            ...
            <nav>
                ...
                <a href="#section8"><span class="menu_name">CONTACTO</span><span class="fa fa-paper-plane"></span> </a>
            </nav>
            <!-- end menu-->
            <!-- social icons -->
            <div class="aside-footer">
                <a href="https://www.facebook.com/profile.php?id=1085150010"><i class="fa fa-facebook" target="_blank"></i></a>
                <a href="https://twitter.com/iramgutzglez" target="_blank"><i class="fa fa-twitter"></i></a>
                <a href="https://www.linkedin.com/pub/iram-guti%C3%A9rrez/49/a52/a21" target="_blank"><i class="fa fa-linkedin"></i></a>
                <a href="https://es.pinterest.com/iramgutzglez/" target="_blank"><i class="fa fa fa-pinterest"></i></a>
                <!--<a href="https://github.com/iramgutz" target="_blank"><i class="fa fa fa-github"></i></a>-->
            </div>
            <!-- end social icons -->
        </aside>
        <!-- End sidebar -->
                ...
                <div id="header">
                    ...
                    <div class="news-scroll">
                        ...
                        <ul id="marquee" class="marquee">
                            <li>
                                A los hombres grandes les pasa lo que a los barriletes; se elevan cuando es mayor el viento que se opone a su ascenso - Jośe Ingenieros</li>
                            <li>
                        ...
                        <span class="quotes"><i class="fa fa-quote-right"></i></span>
                        <div class="downloadCV">
                            <a download="cv/CV_Iram_Gutierrez.pdf" href="cv/CV_Iram_Gutierrez.pdf">
                                <span>
            ...
            <div class="hs-content-wrapper">
                                ...
                                <div class="face1 card-face">
                                    <div class="about-cover card-face">
                                        ...
                                        <div class="about-details">
                                            <div><span class="fa fa-inbox"></span><span class="detail">hola@iramgutierrez.com</span>
                                            </div>
                                            <div><span class="fa fa-phone"></span><span class="detail">044 55 25322569</span>
                                            </div>
                                        </div>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="hobbies">
                                            ...
                                            <div class="hobbie-wrapper row">
                                                <div class="hobbie-icon col-md-3"><i class="fa fa-futbol-o"></i>
                                                </div>
                                            ...
                                            <div class="hobbie-wrapper row">
                                                <div class="hobbie-icon col-md-3"><i class="fa fa-music"></i>
                                                </div>
                                                <div class="hobbie-description col-md-9">
                                                    <p>Duis eu finibus urna. Pellentesque facilisis tellus vel leo accumsan, a tristique est luctus. Morbi quis euismod nulla. Sed eu nibh eros.</p>
                                                </div>
                                            ...
                                            <div class="hobbie-wrapper row">
                                                <div class="hobbie-icon col-md-3"><i class="fa fa-cube"></i>
                                                </div>
                                                <div class="hobbie-description col-md-9">
                                                    <p>Duis eu finibus urna. Pellentesque facilisis tellus vel leo accumsan, a tristique est luctus. Morbi quis euismod nulla. Sed eu nibh eros.</p>
                                                </div>
                                            ...
                                            <div class="hobbie-wrapper row">
                                                <div class="hobbie-icon col-md-3"><i class="fa fa-book"></i>
                                                </div>
                                                <div class="hobbie-description col-md-9">
                                                    <p>Duis eu finibus urna. Pellentesque facilisis tellus vel leo accumsan, a tristique est luctus. Morbi quis euismod nulla. Sed eu nibh eros.</p>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="facts">
                                            ...
                                            <div class="facts-wrapper col-md-6">
                                                ...
                                                <div class="facts-number">1,420</div>
                                                <div class="facts-description">VASOS DE CAFÉ</div>
                                            </div>
                                            <div class="facts-wrapper col-md-6">
                                                <div class="facts-icon"><i class="fa fa-check-square-o"></i>
                                                </div>
                                                <div class="facts-number">65</div>
                                                <div class="facts-description">PROYECTOS COMPLETADOS</div>
                                            </div>
                                            <div class="facts-wrapper col-md-6">
                                                <div class="facts-icon"><i class="fa fa-clock-o"></i>
                                                </div>
                                                <div class="facts-number">10,950</div>
                                                <div class="facts-description">HORAS DE CÓDIGO</div>
                                            </div>
                                            <div class="facts-wrapper col-md-6">
                                                <div class="facts-icon"><i class="fa fa-headphones"></i>
                                                </div>
                                                <div class="facts-number">142,857</div>
                                                <div class="facts-description">CANCIONES ESCUCHADAS</div>
                                            </div>
                                            <div class="facts-wrapper col-md-6">
                                                <div class="facts-icon"><i class="fa-file-code-o fa"></i>
                                                </div>
                                                <div class="facts-number"> 285,714</div>
                                                <div class="facts-description">LINEAS DE CÓDIGO</div>
                                            </div>
                                            <div class="facts-wrapper col-md-6">
                                                <div class="facts-icon"><i class=" li_like"></i>
                                                </div>
                                                <div class="facts-number">100</div>
                                                <div class="facts-description">CLIENTES SATISFECHOS</div>
                                            </div>
                                            <div style="clear:both;"></div>
                                        </div>
                                    </div>
                            ...
                            <ul class="resume">
                                ...
                                <li>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <h3 class="timeline-header">DESARROLLADOR WEB SR.</h3>
                                        <div class="timeline-body">
                                            <h4>SEGUROS MONTERREY NEW YORK LIFE</h4>
                                            <span>Desarrollo de aplicaciónes y módulos sobre la plataforma SugarCRM.</span>
                                        </div>
                                    </div>
                                </li>
                                <li>
                ...
                <article class="hs-content team-section service-section" id="section3">
                    ...
                    <div class="hs-inner">
                        ...
                        <h2>EQUIPO</h2>              
                        <span class="content-title">EQUIPO</span>
                        ...
                        <span class="content-title">CLIENTES</span>
                ...
                <article class="hs-content skills-section" id="section4">
                    ...
                    <div class="hs-inner">
                        ...
                        <h2>EXPERIENCIA</h2>
                        <span class="content-title">BACKEND</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">PHP</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 5 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    ...
                                    <span class="label">Python</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : BÁSICO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                                    <div class="bar-container">
                                        <div class="bar"></div>
                                    </div>
                                    <div style="clear:both;"></div>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="30"></div>                      
                                    <span class="label">Node JS</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : BÁSICO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                        ...
                        <span class="content-title">FRONTEND</span>   
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">JavaScript</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 5 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">HTML 5</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 5 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">CSS 3</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 5 AÑOS</span>
                        ...
                        <span class="content-title">CMS</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">Wordpress</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 4 AÑOS</span>
                                    <div class="bar-container">
                                        <div class="bar"></div>
                                    </div>
                                    <div style="clear:both;"></div>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    ...
                                    <span class="label">ExpressionEngine</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 2 AÑOS</span>
                                    <div class="bar-container">
                                        <div class="bar"></div>
                                    </div>
                                    <div style="clear:both;"></div>
                        ...
                        <span class="content-title">CRM</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="40"></div>                      
                                    <span class="label">Sugar CRM</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 3 MESES</span>
                                    <div class="bar-container">
                                        <div class="bar"></div>
                                    </div>
                                    <div style="clear:both;"></div>
                        ...
                        <span class="content-title">FRAMEWORKS PHP</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="75"></div>                      
                                    <span class="label">Laravel</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 2 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">CakePHP</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 4 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    ...
                                    <span class="label">CodeIgniter</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 2 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="40"></div>                      
                                    <span class="label">PhalconPHP</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : BÁSICO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                        ...
                        <span class="content-title">LIBRERIAS Y FRAMEWORKS JAVASCRIPT</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="90"></div>                      
                                    <span class="label">jQuery</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 4 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="75"></div>                      
                                    <span class="label">AngularJS</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 2 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="40"></div>                      
                                    <span class="label">Backbone.js</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="40"></div>                      
                                    <span class="label">Underscore.js</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                        ...
                        <span class="content-title">FRAMEWORKS MAQUETACIÓN</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="70"></div>                      
                                    <span class="label">Bootstrap 3</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : AVANZADO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 2 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    ...
                                    <span class="label">Materialize</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : Básico</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                        ...
                        <span class="content-title">Pre-procesadores CSS</span>
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="40"></div>                      
                                    <span class="label">Less CSS</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                        ...
                        <div class="skolls">                            
                            <div class="bar-main-container">
                                <div class="wrap">
                                    <div class="bar-percentage" data-percentage="40"></div>                      
                                    <span class="label">Stylus</span><br><br>
                                    <span class="skill-detail"><i class="fa fa-bar-chart">
                                    </i>NIVEL : INTERMEDIO</span>
                                    <span class="skill-detail right">
                                    <i class="fa fa-binoculars"></i>EXPERIENCIA : 1 AÑOS</span>
                            ...
                            <figure class="effect-milo">
                                ...
                                <figcaption>
                                    <a href=".work1" class="open_popup" data-effect="mfp-zoom-out">
                                        ...
                                        <span class="label">
                                            <i class="fa serv-icons fa-code"></i>
                                            <i class="fa serv-icons fa-crop"></i>
                                        </span>
                                            <h3>Baby 2 Baby México</h3>
                                    ...
                                    <div class="mfp-hide mfp-with-anim work_desc work1">
                                        <div class="col-md-6">
                                            <div class="image_work">
                                                <img src="images/portfolio/b2b.jpg" alt="img" width="560">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="project_content">
                                                <h2 class="project_title">Baby 2 Baby México</h2>
                                        ...
                                        <a class="ext_link" href="http://baby2baby.mx" target="_blank" ><i class="fa fa-external-link"></i></a>
                                        <div style="clear:both"></div>
                                    </div>
                                </figcaption>
                            </figure>
                ...
                <!-- service Section -->
                <article class="hs-content team-section service-section" id="section6">
                    <span class="sec-icon serv-icon fa fa-laptop"></span>
                    <div class="hs-inner">
                        <span class="before-title">.06</span>
                        <h2>SERVICIOS</h2>                        
                        <span class="content-title">SERVICIOS</span>
                        ...
                        <span class="content-title">PROCESO</span>
                ...
                <!-- pricing Section -->
                <!--<article class="hs-content pricing-section" id="section7">
                    <span class="sec-icon fa fa-money"></span>
                    <div class="hs-inner">
                        <span class="before-title">.07</span>
                        <h2>PRODUCTOS Y PAQUETES</h2>
